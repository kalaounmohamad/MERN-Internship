...
const Cart = () => {
  ...
  //fct to remove items from cart
  const removeCartItemHandler = (id) => {
    dispatch(removeItemFromCart(id));
  };

  //fct to increse the qty of an item
  ...
  return (
    <>
      ...
      {cartItems.length === 0 ? (
        ...
        <>
          {/* display nb of items in the Cart */}
          <h2 className="mt-5">
            Your Cart: <b> {cartItems.length} items </b>
          </h2>
          {/* Displaying each item in a card */}
